...
from Jokermusic.config import que
from pyrogram import Client, filters
from pyrogram.types import Message

from Jokermusic.function.admins import admins
from Jokermusic.helpers.channelmusic import get_chat_id
from Jokermusic.helpers.decorators import authorized_users_only, errors
...
@Client.on_message(filters.command("mdeauth"))
@authorized_users_only
